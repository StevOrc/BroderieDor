...
/* harmony import */ var _dashboard_produit_dashboard_produit_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./dashboard-produit/dashboard-produit.component */ "./src/app/dashboard-produit/dashboard-produit.component.ts");
...
var routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'produit',
                component: _dashboard_produit_dashboard_produit_component__WEBPACK_IMPORTED_MODULE_13__["DashboardProduitComponent"]
            },
            {
                path: 'theme',
...
/* harmony import */ var _dashboard_produit_dashboard_produit_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./dashboard-produit/dashboard-produit.component */ "./src/app/dashboard-produit/dashboard-produit.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _dashboard_produit_dashboard_produit_component__WEBPACK_IMPORTED_MODULE_26__["DashboardProduitComponent"]
            ],
            imports: [
...
var ADMIN_URLS = {
    ...
    //USER
    ADMIN_USER_URL: '/api/admin/users',
    ADMIN_VALIDATE_USER_URL: '/api/admin/users/validate',
    ADMIN_ADD_PROMOTION_USER_URL: '/api/admin/users/addpromo',
    ADMIN_DELETE_PROMOTION_USER_URL: '/api/admin/users/deletepromo'
...
var DashboardBasketComponent = /** @class */ (function () {
    ...
    DashboardBasketComponent.prototype.createBasket = function () {
        ...
        this.adminService.createBasket(this.selectedBasket).subscribe(function (data) { _this.reloadPage(); }, function (error) { console.log(error); });
    };
...
module.exports = ".customForm{\r\n    padding: 20px;\r\n    border: 5px solid rgba(0, 0, 0, 0.251) !important;\r\n    position: absolute;\r\n    background: snow;\r\n    top: 300px;\r\n}\r\n\r\n#quitter{\r\n    position: absolute;\r\n    right: 5px;\r\n    top: 5px;\r\n}\r\n\r\n.customMessage{\r\n    padding: 25px;\r\n    border: 5px solid rgba(0, 0, 0, 0.251) !important;\r\n    position: absolute;\r\n    background: snow;\r\n    top: 300px;\r\n}\r\n\r\n.customMessage p{\r\n    text-align: center;\r\n}\r\n\r\n.fa-times{\r\n    color : red;\r\n}\r\n\r\n.fa-plus{\r\n    color : green;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var DashboardClientComponent = /** @class */ (function () {
    function DashboardClientComponent(tokenService, seriveAdmin) {
        this.tokenService = tokenService;
        this.seriveAdmin = seriveAdmin;
        this.isLogged = false;
        this.operation = '';
        this.succed = false;
        this.JSONResponse = '';
    ...
    DashboardClientComponent.prototype.getAllUsers = function () {
        var _this = this;
        this.seriveAdmin.getAllUser().subscribe(function (data) { _this.users = data; }, function (error) { console.log(error); });
    };
    DashboardClientComponent.prototype.initOperation = function () {
        this.operation = '';
    };
    DashboardClientComponent.prototype.deleteUser = function () {
        var _this = this;
        this.seriveAdmin.deleteUser(this.selectedUser.idUser).subscribe(function (data) { _this.JSONResponse = data.message; _this.operation = 'SUCCED'; }, function (error) { console.log(error); });
    };
    DashboardClientComponent.prototype.validAccount = function () {
        var _this = this;
        this.seriveAdmin.validUserAccount(this.selectedUser.idUser).subscribe(function (data) { _this.JSONResponse = data.message; _this.operation = 'SUCCED'; }, function (error) { console.log(error); });
    };
    DashboardClientComponent.prototype.initPage = function () {
        this.reloadPage();
    };
    DashboardClientComponent.prototype.promo = function (promo) {
        var _this = this;
        if (promo === false) {
            this.seriveAdmin.deletePromo(this.selectedUser.idUser).subscribe(function (data) { _this.reloadPage(); }, function (error) { console.log(error); });
        }
        else if (promo === true) {
            this.seriveAdmin.addPromo(this.selectedUser.idUser).subscribe(function (data) { _this.reloadPage(); }, function (error) { console.log(error); });
        }
    };
    DashboardClientComponent.prototype.reloadPage = function () {
        window.location.reload();
    };
    DashboardClientComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_auth_token_storage_service__WEBPACK_IMPORTED_MODULE_2__["TokenStorageService"], _service_admin_service__WEBPACK_IMPORTED_MODULE_3__["AdminService"]])
...
module.exports = "h3{\r\n    margin-top: 100px;\r\n    text-align: center;  \r\n}\r\n\r\np.messageLoggedOut{\r\n    text-align: center;\r\n    font-size: 1.5em;\r\n}\r\n\r\n/*Connected*/\r\n\r\nmain{\r\n    display: flex;\r\n    flex-direction: row;\r\n}\r\n\r\n.table-wrapper {\r\n    background: #fff;\r\n    padding: 20px 25px;\r\n    margin: 30px 0;\r\n    border-radius: 3px;\r\n    box-shadow: 0 1px 1px rgba(0,0,0,.05);\r\n}\r\n\r\n.table-title {        \r\n    padding-bottom: 15px;\r\n    background: #435d7d;\r\n    color: #fff;\r\n    padding: 16px 30px;\r\n    margin: -20px -25px 10px;\r\n    border-radius: 3px 3px 0 0;\r\n}\r\n\r\n.table-title h2 {\r\n    margin: 5px 0 0;\r\n    font-size: 24px;\r\n}\r\n\r\n.table-title .btn-group {\r\n    float: right;\r\n}\r\n\r\n.table-title .btn {\r\n    color: #fff;\r\n    float: right;\r\n    font-size: 13px;\r\n    border: none;\r\n    min-width: 50px;\r\n    border-radius: 2px;\r\n    border: none;\r\n    outline: none !important;\r\n    margin-left: 10px;\r\n}\r\n\r\n.table-title .btn i {\r\n    float: left;\r\n    font-size: 21px;\r\n    margin-right: 5px;\r\n}\r\n\r\n.table-title .btn span {\r\n    float: left;\r\n    margin-top: 2px;\r\n}\r\n\r\ntable.table tr th, table.table tr td {\r\n    border-color: #e9e9e9;\r\n    padding: 12px 15px;\r\n    vertical-align: middle;\r\n}\r\n\r\ntable.table tr th:first-child {\r\n    width: 150px;\r\n}\r\n\r\ntable.table tr th:last-child {\r\n    width: 100px;\r\n}\r\n\r\ntable.table-striped tbody tr:nth-of-type(odd) {\r\n    background-color: #fcfcfc;\r\n}\r\n\r\ntable.table-striped.table-hover tbody tr:hover {\r\n    background: #f5f5f5;\r\n}\r\n\r\ntable.table th i {\r\n    font-size: 13px;\r\n    margin: 0 5px;\r\n    cursor: pointer;\r\n}\r\n\r\ntable.table td:last-child i {\r\n    opacity: 0.9;\r\n    font-size: 22px;\r\n    margin: 0 5px;\r\n}\r\n\r\ntable.table td a {\r\n    font-weight: bold;\r\n    color: #566787;\r\n    display: inline-block;\r\n    text-decoration: none;\r\n    outline: none !important;\r\n}\r\n\r\ntable.table td a:hover {\r\n    color: #2196F3;\r\n}\r\n\r\ntable.table td a.edit {\r\n    color: #FFC107;\r\n}\r\n\r\ntable.table td a.delete {\r\n    color: #F44336;\r\n}\r\n\r\ntable.table td i {\r\n    font-size: 19px;\r\n}\r\n\r\ntable.table .avatar {\r\n    border-radius: 50%;\r\n    vertical-align: middle;\r\n    margin-right: 10px;\r\n}\r\n\r\n/*Button EDIT and DELETE*/\r\n\r\n.crudTD{\r\n    display: flex;\r\n    flex-direction: row;\r\n}\r\n\r\n.crudTD i.fa-edit{\r\n    color: orange;\r\n}\r\n\r\n.crudTD i.fa-trash-alt{\r\n    color: red;\r\n}\r\n\r\n/*Form for CRUD*/\r\n\r\n.customForm{\r\n    position: fixed;\r\n    left: 25%;\r\n    width: 30%;\r\n}\r\n\r\nform{\r\n    margin-top: 30px;\r\n    margin-left: 5px;\r\n    height: 23%;\r\n    display: flex;\r\n    flex-direction: column;\r\n    padding: 25px;\r\n    border: 5px solid rgba(0, 0, 0, 0.251);\r\n    background: white;\r\n    border-radius: 5px !important;\r\n}\r\n\r\n.input-group{\r\n    display: flex;\r\n    flex-direction: column;\r\n}\r\n\r\n.form-control{\r\n    width: 90%;\r\n}\r\n\r\n.input-group .btn{\r\n    margin-top: 10px;\r\n    width: 50%;\r\n}\r\n\r\n.titleForm{\r\n    text-align: center;\r\n    font : bold;\r\n}\r\n\r\n.customBtnLeave{\r\n    position: absolute;\r\n    right: 35px;\r\n    top: 45px;\r\n}\r\n\r\n.customBtnReload{\r\n    position: absolute;\r\n    right: 65px;\r\n    top: 45px;\r\n}\r\n\r\n#deleteProduct{\r\n    margin-top: 30px;\r\n    margin-left: 5px;\r\n    height: 23%;\r\n    display: flex;\r\n    flex-direction: column;\r\n    padding: 25px;\r\n    border: 5px solid rgba(0, 0, 0, 0.251);\r\n    border-radius: 5px !important;\r\n    background: white;\r\n}\r\n\r\n@media screen and (max-width: 1100px){\r\n    .customForm{\r\n        left: 15%;\r\n        width: 50%;\r\n    }\r\n }\r\n\r\n@media screen and (max-width: 600px){\r\n    .customForm{\r\n        top: 5%;\r\n        left: 15%;\r\n        width: 70%;\r\n    }\r\n }\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "h2{\r\n    margin-top: 100px;\r\n    text-align: center;\r\n}\r\n\r\nh3{\r\n    margin-top: 100px;\r\n    text-align: center;  \r\n}\r\n\r\np.messageLoggedOut{\r\n    text-align: center;\r\n    font-size: 1.5em;\r\n}\r\n\r\n/*Connected*/\r\n\r\nmain{\r\n    display: flex;\r\n    flex-direction: row;\r\n}\r\n\r\n.table-wrapper {\r\n    background: #fff;\r\n    padding: 20px 25px;\r\n    margin: 30px 0;\r\n    border-radius: 3px;\r\n    box-shadow: 0 1px 1px rgba(0,0,0,.05);\r\n}\r\n\r\n.table-title {        \r\n    padding-bottom: 15px;\r\n    background: #435d7d;\r\n    color: #fff;\r\n    padding: 16px 30px;\r\n    margin: -20px -25px 10px;\r\n    border-radius: 3px 3px 0 0;\r\n}\r\n\r\n.table-title h2 {\r\n    margin: 5px 0 0;\r\n    font-size: 24px;\r\n}\r\n\r\n.table-title .btn-group {\r\n    float: right;\r\n}\r\n\r\n.table-title .btn {\r\n    color: #fff;\r\n    float: right;\r\n    font-size: 13px;\r\n    border: none;\r\n    min-width: 50px;\r\n    border-radius: 2px;\r\n    border: none;\r\n    outline: none !important;\r\n    margin-left: 10px;\r\n}\r\n\r\n.table-title .btn i {\r\n    float: left;\r\n    font-size: 21px;\r\n    margin-right: 5px;\r\n}\r\n\r\n.table-title .btn span {\r\n    float: left;\r\n    margin-top: 2px;\r\n}\r\n\r\ntable.table tr th, table.table tr td {\r\n    border-color: #e9e9e9;\r\n    padding: 12px 15px;\r\n    vertical-align: middle;\r\n}\r\n\r\ntable.table tr th:first-child {\r\n    width: 150px;\r\n}\r\n\r\ntable.table tr th:last-child {\r\n    width: 100px;\r\n}\r\n\r\ntable.table-striped tbody tr:nth-of-type(odd) {\r\n    background-color: #fcfcfc;\r\n}\r\n\r\ntable.table-striped.table-hover tbody tr:hover {\r\n    background: #f5f5f5;\r\n}\r\n\r\ntable.table th i {\r\n    font-size: 13px;\r\n    margin: 0 5px;\r\n    cursor: pointer;\r\n}\r\n\r\ntable.table td:last-child i {\r\n    opacity: 0.9;\r\n    font-size: 22px;\r\n    margin: 0 5px;\r\n}\r\n\r\ntable.table td a {\r\n    font-weight: bold;\r\n    color: #566787;\r\n    display: inline-block;\r\n    text-decoration: none;\r\n    outline: none !important;\r\n}\r\n\r\ntable.table td a:hover {\r\n    color: #2196F3;\r\n}\r\n\r\ntable.table td a.edit {\r\n    color: #FFC107;\r\n}\r\n\r\ntable.table td a.delete {\r\n    color: #F44336;\r\n}\r\n\r\ntable.table td i {\r\n    font-size: 19px;\r\n}\r\n\r\ntable.table .avatar {\r\n    border-radius: 50%;\r\n    vertical-align: middle;\r\n    margin-right: 10px;\r\n}\r\n\r\n/*Button EDIT and DELETE*/\r\n\r\n.crudTD{\r\n    display: flex;\r\n    flex-direction: row;\r\n}\r\n\r\n.crudTD i.fa-edit{\r\n    color: orange;\r\n}\r\n\r\n.crudTD i.fa-trash-alt{\r\n    color: red;\r\n}\r\n\r\n/*Form for CRUD*/\r\n\r\n.input-group{\r\n    display: flex;\r\n    flex-direction: column;\r\n}\r\n\r\n.form-control{\r\n    width: 90%;\r\n}\r\n\r\n.input-group .btn{\r\n    margin-top: 10px;\r\n    width: 50%;\r\n}\r\n\r\n.titleForm{\r\n    text-align: center;\r\n    font : bold;\r\n}\r\n\r\n.customForm{\r\n    margin-top: 30px;\r\n    margin-left: 5px;\r\n    height: 23%;\r\n    width: 50%;\r\n    position: fixed;\r\n    top : 200px;\r\n    display: flex;\r\n    flex-direction: column;\r\n    background: white;\r\n}\r\n\r\nform{\r\n    border: 5px solid rgba(0, 0, 0, 0.251);\r\n    padding: 20px;\r\n    background: white;\r\n}\r\n\r\n.fa-times{\r\n    position: absolute;\r\n    right: 25px;\r\n    top : 15px;\r\n}\r\n\r\n#deleteBasket{\r\n    border: 5px solid rgba(0, 0, 0, 0.251);\r\n    padding: 20px;\r\n    background: white;\r\n}\r\n\r\n@media screen and (max-width: 1100px){\r\n    .customForm{\r\n        left: 15%;\r\n        width: 50%;\r\n    }\r\n }\r\n\r\n@media screen and (max-width: 800px){\r\n    .customForm{\r\n        top: 1%;\r\n        left: 15%;\r\n        width: 70%;\r\n    }\r\n }\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ThemeComponent = /** @class */ (function () {
    ...
    ThemeComponent.prototype.addTheme = function () {
        var _this = this;
        this.adminService.createTheme(this.selectedTheme).subscribe(function (data) { _this.reloadPage(); }, function (error) { console.log(error); });
    };
    ThemeComponent.prototype.updateTheme = function () {
        var _this = this;
        this.adminService.updateTheme(this.selectedTheme).subscribe(function (data) { _this.reloadPage(); }, function (error) { console.log(error); });
    };
    ThemeComponent.prototype.deleteTheme = function () {
        var _this = this;
        this.adminService.deleteTheme(this.selectedTheme.idTheme).subscribe(function (data) { _this.reloadPage(); }, function (error) { console.log(error); });
    };
    ThemeComponent.prototype.initOperation = function () {
        this.operation = '';
    };
...
module.exports = "h3{\r\n    text-align: center;\r\n    margin-top: 100px; \r\n}\r\n\r\np{\r\n    text-align: center;\r\n}\r\n\r\nnav#gestion{\r\n    margin-top: 100px;\r\n}\r\n\r\nnav#gestion button{\r\n    color: #fff;\r\n    background: gray;\r\n    font-size: 13px;\r\n    border: none;\r\n    min-width: 50px;\r\n    border-radius: 2px;\r\n    border: none;\r\n    outline: none !important;\r\n    margin-left: 10px;\r\n}\r\n\r\n@media screen and (max-width: 850px){\r\n    #navbas{\r\n        display: none;\r\n    }\r\n }\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "#burger{\r\n    display: none;\r\n}\r\n\r\nheader{\r\n    position: relative;\r\n    width: 100%;\r\n    height: 95px;\r\n    background: #191919;\r\n    display: flex;\r\n    flex-wrap : wrap;\r\n    justify-content: space-between;\r\n    top : 0;\r\n    left: 0;\r\n    z-index: 2;\r\n    border-bottom: 2px solid #DAA520;\r\n}\r\n\r\nheader nav#navhaut{\r\n    display: flex;\r\n    width: 80%;\r\n    margin: auto;\r\n    height: 95px;\r\n    background: #191919;\r\n    flex-wrap: wrap;\r\n    color : #DAA520;\r\n    border-bottom: 2px solid #DAA520;\r\n}\r\n\r\nheader #logo{\r\n    width: 50%;\r\n    padding-top: 5px;\r\n}\r\n\r\nheader #logo img{\r\n    width: 130px;\r\n    position: absolute;\r\n    /* top : -10px; */\r\n}\r\n\r\nheader #login{\r\n    display: flex;\r\n    width: 50%;\r\n    flex-direction: column;\r\n    align-items: flex-end;\r\n    flex-wrap: wrap;\r\n    padding-top: 15px;\r\n}\r\n\r\nheader #login #icons{\r\n    margin-top : 10px;\r\n}\r\n\r\n#iconLogin{\r\n    margin-right: 15px;\r\n}\r\n\r\nheader #navhaut #login #icons a{\r\n    color : #DAA520;\r\n    text-decoration: none;\r\n}\r\n\r\nheader #navhaut #login #icons a:hover{\r\n    color : white;\r\n    text-decoration: none;\r\n}\r\n\r\n#burgerSide i{\r\n    margin-top: 25px;\r\n    margin-left: 20px;\r\n    font-size: 40px;\r\n    height: 40px;\r\n    color: #DAA520;\r\n}\r\n\r\n#logout {\r\n    color : #DAA520;\r\n}\r\n\r\n#logout i {\r\n    color : #DAA520;\r\n}\r\n\r\n/*Nav For responsive*/\r\n\r\nnav#navResponsvie{\r\n    background: white;\r\n    display: none;\r\n}\r\n\r\nnav#navResponsvie button{\r\n    background: white;\r\n    border: none;\r\n    border-radius: none;\r\n}\r\n\r\nnav#navResponsvie a{\r\n    color: black;\r\n    \r\n}\r\n\r\n/*RESPONSIVE*/\r\n\r\n@media screen and (max-width: 1100px){\r\n\r\n    #endspace{\r\n        display: none;\r\n    }\r\n}\r\n\r\n@media screen and (max-width: 950px){\r\n\r\n    header #navbas nav ul a{\r\n        font-size: 1em;\r\n    }\r\n\r\n    \r\n}\r\n\r\n@media screen and (max-width: 850px){\r\n    header{\r\n        display: none;\r\n    }\r\n    #navbas{\r\n        display: none;\r\n    }\r\n\r\n    #logout {\r\n        color : black;\r\n    }\r\n    \r\n    #logout i {\r\n        color : black;\r\n    }\r\n\r\n    #navMediumSmall{\r\n        display: block;\r\n    \r\n    }\r\n\r\n    nav#navResponsvie{\r\n        display: block;\r\n    }\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "#navbas{\r\n    width: 100%;\r\n    margin: auto;\r\n    height: 50px;\r\n    background: white;\r\n    border-bottom: 1px solid white;\r\n    z-index: 99999;\r\n}\r\n\r\n\r\n#navbas nav ul li a{\r\n    transition: 0.2s;\r\n    height: 50px;\r\n    color : black;\r\n}\r\n\r\n\r\n#navbas nav ul li a:hover{\r\n    border-bottom: 3px solid #DAA520;\r\n}\r\n\r\n\r\n#navbas{\r\n    position: absolute;\r\n    top : 95px;\r\n}\r\n\r\n\r\n#navbas nav{\r\n    width: 80%;\r\n    margin: auto;\r\n    height: 40px;\r\n    background: white;\r\n}\r\n\r\n\r\n#navbas #endspace{\r\n    width: 15%;\r\n}\r\n\r\n\r\n#navbas nav ul{\r\n    display: flex;\r\n    flex-wrap: wrap;\r\n    list-style: none;\r\n}\r\n\r\n\r\n#navbas nav ul{\r\n    display: flex;\r\n    flex-wrap: wrap;\r\n    list-style: none;\r\n    justify-content: space-around; \r\n}\r\n\r\n\r\n#navbas nav ul a{\r\n    display: block;\r\n    text-decoration: none;\r\n    color : #191919;\r\n    line-height: 50px;\r\n    transition: 0.5s;\r\n    font-size: 1.1em;\r\n}\r\n\r\n\r\n#navMediumSmall{\r\n    display: none;\r\n}\r\n\r\n\r\n/*MAIN*/\r\n\r\n\r\nem{\r\n    font-style: normal;\r\n    font-weight: bold;\r\n    color: #DAA520;\r\n}\r\n\r\n\r\nli{\r\n    list-style: none;\r\n}\r\n\r\n\r\n/*Main*/\r\n\r\n\r\nmain{\r\n    width: 100%;\r\n    height: auto;\r\n    margin-bottom: 20px;\r\n}\r\n\r\n\r\nmain #descriptif h1{\r\n    margin-top : 15px;\r\n    text-align: center;\r\n    font-family: 'Great Vibes', cursive;\r\n    font-size: 3em;\r\n}\r\n\r\n\r\nmain #descriptif h2{\r\n    margin-top: 30px;\r\n    margin-bottom: 50px;\r\n    text-align: center;\r\n    font-size: 2em;\r\n}\r\n\r\n\r\nmain #descriptif p{\r\n    width: 80%;\r\n    margin: auto;\r\n    text-align: justify;\r\n}\r\n\r\n\r\nmain #hrhaut{\r\n    background: #191919;\r\n    width: 50%;\r\n    margin: auto;\r\n    margin-top: 25px;\r\n    margin-bottom: 10px;\r\n}\r\n\r\n\r\nmain #hrbas{\r\n    background: #191919;\r\n    width: 50%;\r\n    margin: auto;\r\n    margin-bottom: 10px;\r\n}\r\n\r\n\r\n.list li{\r\n    width: 100%;\r\n    text-align: left;\r\n}\r\n\r\n\r\n/*TEST SECTION*/\r\n\r\n\r\nmain div.offre .card{\r\n    margin : 0;\r\n    padding: 0;\r\n    border-radius: 0;\r\n}\r\n\r\n\r\nmain div.offre{\r\n    display: flex;\r\n    flex-wrap: wrap; \r\n}\r\n\r\n\r\nmain div.offre .card-header{\r\n    text-align: center;\r\n    width: 100%;\r\n    background: #DAA520;\r\n}\r\n\r\n\r\n/* CUSTOM the color of h5's cards-header*/\r\n\r\n\r\nmain div.offre .card-header h5{\r\n    color: white\r\n}\r\n\r\n\r\n.card-footer{\r\n    text-align: center;\r\n    /* background: rgba(0, 0, 0, 0.251); */\r\n    background: #DAA520;\r\n}\r\n\r\n\r\n.card-footer a{\r\n    color: #191919;\r\n}\r\n\r\n\r\n/*JUMBOTRON*/\r\n\r\n\r\n.jumbotron{\r\n    background: #191919;\r\n    color: #DAA520\r\n}\r\n\r\n\r\n.jumbotron h2{\r\n    font-family: 'Great Vibes', cursive;\r\n    font-size: 4.1em\r\n}\r\n\r\n\r\n.jumbotron p{\r\n    font-family: 'Roboto', sans-serif;\r\n}\r\n\r\n\r\n/* smartphones, iPhone, portrait 480x320 phones */\r\n\r\n\r\n@media (min-width:320px)  { \r\n\r\n}\r\n\r\n\r\n/* portrait e-readers (Nook/Kindle), smaller tablets @ 600 or @ 640 wide. */\r\n\r\n\r\n@media screen and (max-width: 481px)  { \r\n    #carouselExampleInterval{\r\n        display: none;\r\n    }\r\n\r\n    #offre div.customnaissance{\r\n        padding-left: 0px;\r\n        padding-right: 0px;\r\n    }\r\n\r\n }\r\n\r\n\r\n/* portrait tablets, portrait iPad, landscape e-readers, landscape 800x480 or 854x480 phones */\r\n\r\n\r\n@media screen and (max-width: 801px)  { \r\n    #offre div.customnaissance{\r\n        display: flex;\r\n        flex-direction: column;\r\n        padding-left: 50px;\r\n        padding-right: 50px;\r\n    }\r\n\r\n    main #descriptif h1{\r\n        font-size: 2em;\r\n        padding-top : 0;\r\n        margin-top : 0;\r\n    }\r\n\r\n    main #descriptif h2{\r\n        font-size: 1.3em;\r\n        padding-bottom: 0;\r\n        margin-bottom: 15px;\r\n    }\r\n    main #descriptif p{\r\n        width: 95%;\r\n        font-size: 0.9em;\r\n    }\r\n    #hrbas{\r\n        display: none;\r\n    }\r\n    main #hrhaut{\r\n        display: none;\r\n    }\r\n\r\n    .card{\r\n        width: 80%;\r\n        margin: auto;\r\n    }\r\n\r\n    .jumbotron h2{\r\n        font-size: 2.5em;\r\n    }\r\n    .jumbotron p{\r\n        font-size: 0.9em;\r\n    }\r\n\r\n }\r\n\r\n\r\n@media screen and (max-width: 850px){\r\n     \r\n    #navbas{\r\n        display: none;\r\n    }\r\n\r\n    app-carousel{\r\n        display: none;\r\n    }\r\n }\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.allThemes = function () {
        var _this = this;
        this.themeSerive.getAllThemes().subscribe(function (data) { _this.listThemes = data; }, function (err) { console.log(err); });
    };
...
module.exports = "form{\r\n    width: 35%;\r\n    margin: auto;\r\n    margin-top: 100px;\r\n    padding: 20px;\r\n    border: 20px solid black;\r\n}\r\n\r\n#title{\r\n    margin-top: 100px; \r\n}\r\n\r\nh2, p{\r\n    text-align: center; \r\n}\r\n\r\n@media screen and (max-width: 900px){\r\n    form{\r\n        width: 70%;\r\n    }\r\n}\r\n\r\n@media screen and (max-width: 800px){\r\n    form{\r\n        width: 60%;\r\n    }\r\n\r\n    #navbas{\r\n        display: none;\r\n    }\r\n}\r\n\r\n@media screen and (max-width: 500px){\r\n    form{\r\n        width: 90%;\r\n    }\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var Basket = /** @class */ (function () {
    function Basket(idBasket, name, price, theme, basketLines, urlPhoto) {
...
module.exports = "/* MAIN */\r\n#sectionProduit{\r\n    width: 100%;\r\n    margin: auto;\r\n    margin-left: 50px;\r\n    display: flex;\r\n}\r\nsection div.card{\r\n    border : 1px solid gray;\r\n    border-radius: 0;\r\n    margin: 15px;\r\n}\r\nh2{\r\n    text-align: center;\r\n}\r\n#hrhaut{\r\n    background: black;\r\n    width: 5%;\r\n    margin: auto;\r\n    margin-top: 25px;\r\n    margin-bottom: 10px;\r\n    border : 1px solid black;\r\n}\r\n#hrbas{\r\n    background: black;\r\n    width: 5%;\r\n    margin: auto;\r\n    margin-bottom: 10px;\r\n    border : 1px solid black;\r\n}\r\n#descriptif h1{\r\n    margin-top : 15px;\r\n    text-align: center;\r\n    font-family: 'Roboto', sans-serif;\r\n    font-size: 3em;\r\n}\r\n#descriptif h2{\r\n    margin-top: 30px;\r\n    margin-bottom: 50px;\r\n    text-align: center;\r\n    font-size: 2em;\r\n}\r\n#descriptif p{\r\n    width: 80%;\r\n    margin: auto;\r\n    text-align: justify;\r\n}\r\n/* CARD */\r\n.card{\r\n    padding: 1px;\r\n    border: 5px solid rgba(0, 0, 0, 0.251) !important;\r\n    border-radius: 5px !important;\r\n}\r\n.card p{\r\n    text-align: center;\r\n}\r\n@media screen and (max-width: 850px){\r\n     #navbas{\r\n         display: none;\r\n     }\r\n }\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ProductComponent = /** @class */ (function () {
    ...
    ProductComponent.prototype.getAllProduct = function () {
        var _this = this;
        this.productService.getAllProduits().subscribe(function (data) { _this.listProduct = data; }, function (error) { console.log(error); });
    };
...
module.exports = "#success{\r\n    margin-top : 100px;\r\n    text-align: center;\r\n}\r\n\r\n\r\nform{\r\n    width: 40%;\r\n    margin: auto;\r\n    margin-top: 100px;\r\n    padding: 20px;\r\n    border: 20px solid black;\r\n}\r\n\r\n\r\n@media screen and (max-width: 900px){\r\n    form{\r\n        width: 70%;\r\n    }\r\n\r\n}\r\n\r\n\r\n@media screen and (max-width: 850px){\r\n    form{\r\n        width: 80%;\r\n    }\r\n    #navbas{\r\n        display: none;\r\n    }\r\n}\r\n\r\n\r\n@media screen and (max-width: 500px){\r\n    form{\r\n        width: 90%;\r\n    }\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AdminService = /** @class */ (function () {
    ...
    AdminService.prototype.getAllUser = function () {
        return this.http.get(_config_url_CRUD_admin_url__WEBPACK_IMPORTED_MODULE_4__["ADMIN_URLS"].ADMIN_USER_URL, { headers: this.header });
    };
    AdminService.prototype.validUserAccount = function (id) {
        return this.http.post(_config_url_CRUD_admin_url__WEBPACK_IMPORTED_MODULE_4__["ADMIN_URLS"].ADMIN_VALIDATE_USER_URL + '/' + ("" + id), {}, { headers: this.header });
    };
    AdminService.prototype.deletePromo = function (id) {
        return this.http.post(_config_url_CRUD_admin_url__WEBPACK_IMPORTED_MODULE_4__["ADMIN_URLS"].ADMIN_DELETE_PROMOTION_USER_URL + '/' + ("" + id), {}, { headers: this.header });
    };
    AdminService.prototype.addPromo = function (id) {
        return this.http.post(_config_url_CRUD_admin_url__WEBPACK_IMPORTED_MODULE_4__["ADMIN_URLS"].ADMIN_ADD_PROMOTION_USER_URL + '/' + ("" + id), {}, { headers: this.header });
    };
    AdminService.prototype.deleteUser = function (id) {
        return this.http.delete(_config_url_CRUD_admin_url__WEBPACK_IMPORTED_MODULE_4__["ADMIN_URLS"].ADMIN_USER_URL + '/' + ("" + id), { headers: this.header });
    };
...
module.exports = "h3{\r\n    margin-top: 100px;\r\n    text-align: center;  \r\n}\r\n\r\np.messageLoggedOut{\r\n    text-align: center;\r\n    font-size: 1.5em;\r\n}\r\n\r\n/*Connected*/\r\n\r\nmain{\r\n    display: flex;\r\n    flex-direction: row;\r\n    margin-top: 50px;\r\n}\r\n\r\n.table-wrapper {\r\n    background: #fff;\r\n    padding: 20px 25px;\r\n    margin: 30px 0;\r\n    border-radius: 3px;\r\n    box-shadow: 0 1px 1px rgba(0,0,0,.05);\r\n}\r\n\r\n.table-title {        \r\n    padding-bottom: 15px;\r\n    background: #435d7d;\r\n    color: #fff;\r\n    padding: 16px 30px;\r\n    margin: -20px -25px 10px;\r\n    border-radius: 3px 3px 0 0;\r\n}\r\n\r\n.table-title h2 {\r\n    margin: 5px 0 0;\r\n    font-size: 24px;\r\n}\r\n\r\n.table-title .btn-group {\r\n    float: right;\r\n}\r\n\r\n.table-title .btn {\r\n    color: #fff;\r\n    float: right;\r\n    font-size: 13px;\r\n    border: none;\r\n    min-width: 50px;\r\n    border-radius: 2px;\r\n    border: none;\r\n    outline: none !important;\r\n    margin-left: 10px;\r\n}\r\n\r\n.table-title .btn i {\r\n    float: left;\r\n    font-size: 21px;\r\n    margin-right: 5px;\r\n}\r\n\r\n.table-title .btn span {\r\n    float: left;\r\n    margin-top: 2px;\r\n}\r\n\r\ntable.table tr th, table.table tr td {\r\n    border-color: #e9e9e9;\r\n    padding: 12px 15px;\r\n    vertical-align: middle;\r\n}\r\n\r\ntable.table tr th:first-child {\r\n    width: 150px;\r\n}\r\n\r\ntable.table tr th:last-child {\r\n    width: 100px;\r\n}\r\n\r\ntable.table-striped tbody tr:nth-of-type(odd) {\r\n    background-color: #fcfcfc;\r\n}\r\n\r\ntable.table-striped.table-hover tbody tr:hover {\r\n    background: #f5f5f5;\r\n}\r\n\r\ntable.table th i {\r\n    font-size: 13px;\r\n    margin: 0 5px;\r\n    cursor: pointer;\r\n}\r\n\r\ntable.table td:last-child i {\r\n    opacity: 0.9;\r\n    font-size: 22px;\r\n    margin: 0 5px;\r\n}\r\n\r\ntable.table td a {\r\n    font-weight: bold;\r\n    color: #566787;\r\n    display: inline-block;\r\n    text-decoration: none;\r\n    outline: none !important;\r\n}\r\n\r\ntable.table td a:hover {\r\n    color: #2196F3;\r\n}\r\n\r\ntable.table td a.edit {\r\n    color: #FFC107;\r\n}\r\n\r\ntable.table td a.delete {\r\n    color: #F44336;\r\n}\r\n\r\ntable.table td i {\r\n    font-size: 19px;\r\n}\r\n\r\ntable.table .avatar {\r\n    border-radius: 50%;\r\n    vertical-align: middle;\r\n    margin-right: 10px;\r\n}\r\n\r\n/*Button EDIT and DELETE*/\r\n\r\n.crudTD{\r\n    display: flex;\r\n    flex-direction: row;\r\n}\r\n\r\n.crudTD i.fa-edit{\r\n    color: orange;\r\n}\r\n\r\n.crudTD i.fa-trash-alt{\r\n    color: red;\r\n}\r\n\r\n/*Form for CRUD*/\r\n\r\nform, #deleteBasket{\r\n    margin-top: 30px;\r\n    margin-left: 5px;\r\n    height: 23%;\r\n    display: flex;\r\n    flex-direction: column;\r\n    padding: 20px;\r\n    border: 10px solid black;\r\n    background: snow;\r\n}\r\n\r\n.input-group{\r\n    display: flex;\r\n    flex-direction: column;\r\n}\r\n\r\n.form-control{\r\n    width: 90%;\r\n}\r\n\r\n.input-group .btn{\r\n    margin-top: 10px;\r\n    width: 50%;\r\n}\r\n\r\n.titleForm{\r\n    text-align: center;\r\n    font : bold;\r\n}\r\n\r\n.customForm{\r\n    width: 85%;\r\n    margin: auto;\r\n    position: absolute;\r\n    top: 250px;\r\n    left: 50px;\r\n}\r\n\r\nli{\r\n    list-style: none;\r\n}\r\n\r\n#quitter{\r\n    position: absolute;\r\n    top: 40px;\r\n    right: 25px;\r\n}\r\n\r\n#reload{\r\n    position: absolute;\r\n    top: 40px;\r\n    right: 70px;\r\n}\r\n\r\n#quitter i{\r\n    font-size: 1.3em;\r\n}\r\n\r\n.fa-plus{\r\n    color: green\r\n}\r\n\r\n.fa-minus{\r\n    color: red;\r\n}\r\n\r\n.customInput{\r\n    display: flex;\r\n    margin-top: 10px;\r\n}\r\n\r\n.customInput select{\r\n    width: 50%;\r\n}\r\n\r\n.customInput input{\r\n    width: 20%;\r\n    margin-left: 15px;\r\n}\r\n\r\n.customInput button{\r\n    width: 20% !important;\r\n}\r\n\r\n#successUpdate{\r\n    text-align: center;\r\n}\r\n\r\n@media screen and (max-width: 800px){\r\n    #navbas{\r\n        display: none;\r\n    }\r\n}\r\n\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<div id=\"navbas\">\n    <nav role=\"navigation\" id=\"navNavbas\">\n        <ul>\n            <li><a href=\"#\" class=\"linkNavbas\"><i class=\"fas fa-home\"></i> Home</a></li>\n            <!-- Loop *ngFor on listThemes to genrate nav menu links depending on theme in Database.theme-->\n            <li><a href=\"/produit\" class=\"linkNavbas\">Boutique d'Or</a></li>\n            <li><a href=\"home#contact\" target=\"_self\" class=\"linkNavbas\">Contact</a></li>\n        </ul>\n    </nav>\n  </div>\n\n  <h3 *ngIf=\"!isLogged\">\n        Vous n'êtes pas connecté\n      </h3>\n      <p *ngIf=\"!isLogged\" class=\"messageLoggedOut\">Connectez vous pour accéder à votre espace</p>\n\n  <main *ngIf=\"isLogged\" class=\"container-fluid\">\n    <div class=\"table-wrapper col-lg-7\">\n        <section class=\"table-title\">\n              <div class=\"row\">\n                  <div class=\"col-sm-6\">\n                      <h2>Vos données</h2>\n                  </div>\n              </div>\n          </section>\n        <table class=\"table table-striped table-hover\">\n          <thead>\n              <tr>\n                <th>Prémon</th> \n                <th>Nom</th> \n                <th>Téléphone</th>\n                <th>Pseudo</th>\n                <th>email</th>\n                <th>Etat du compte</th>\n                <th>Promotion</th>\n              </tr>     \n          </thead>\n          <tbody>\n            <tr>\n              <td> {{currentUser.firstName}} </td>\n              <td> {{currentUser.lastName}} </td>\n              <td> {{currentUser.phone}} </td>\n              <td> {{currentUser.username}} </td>\n              <td> {{currentUser.email}} </td>\n              <td> {{currentUser.valid == false ? 'an attente validation' : 'validé'}} </td>\n              <td *ngIf=\"currentUser.promotion == false\"> Vous n'avez pas de promotion</td>\n              <td *ngIf=\"currentUser.promotion == true\"> -15% en boutique ! <i class=\"far fa-smile\"></i></td>\n            </tr>\n              <tr>\n          </tbody>\n        </table>\n    </div>\n  </main>"
...
var UserspaceComponent = /** @class */ (function () {
    ...
    UserspaceComponent.prototype.getUser = function () {
        var _this = this;
        this.userService.getUser(this.tokenStorage.getUsername()).subscribe(function (data) { _this.currentUser = data; }, function (error) { console.log(error); });
    };
    ...
    UserspaceComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_auth_token_storage_service__WEBPACK_IMPORTED_MODULE_2__["TokenStorageService"], _service_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]])
    ], UserspaceComponent);
